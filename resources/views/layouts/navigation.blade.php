            ...
            <div class="hidden lg:flex items-center gap-3">
                ...
                <a href="@auth{{ route('wishlist.index') }}@else{{ route('login') }}@endauth" 
                   class="relative p-2 rounded-lg hover:bg-gray-50 transition-colors group">
                    ...
                    @auth
                    <span id="wishlist-count" class="absolute -top-1 -right-1 bg-primary-600 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center font-bold">0</span>
                    @endauth
                </a>
                ...
                class="relative p-2 rounded-lg hover:bg-gray-50 transition-colors group">
                    ...
                    <span id="cart-count" class="absolute -top-1 -right-1 bg-primary-600 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center font-bold">0</span>
                </a>
